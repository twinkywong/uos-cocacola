    ...
    <nav id="headerColor" class="navbar sticky-top navbar-expand-sm navbar_coca_cola">
      ...
      <div class="container-fluid">
              ...
              <div class="card text-left">
                <div class="card-header">
                    <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                        <button id="FantaButton" type="button" class="btn btn-primary" onMouseUp="fantaScene(); fantaDescription();">Dr Pepper</button>
                        <button id="CokeButton" type="button" class="btn btn-outline-primary" onMouseUp="cokeScene(); cokeDescription();">Sprite</button>
                        <button id="CostaButton" type="button" class="btn btn-outline-primary" onMouseUP="costaScene(); costaDescription();">Costa</button>
                        <button id="CokeCanButton" type="button" class="btn btn-outline-primary" onMouseUp="cokeCanScene(); cokeCanDescription();">Coke Can</button>
                    </div>
                ...
                <div class="card-body">
                  ...
                  <div>
                    ...
                    <div id="x3dModelTitle_cokeCan" class="card-title drinksText"></div>
                    ...
                    <div id="x3dCreationMethod_cokeCan" class="card-text drinksText"></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div id="interaction" class="row" style="display:none;">
          ...
          <div class="col-sm-4">
            <div class="card text-left">
              ...
              <div class="card-body" id="CokeCan_cam" style="display:none;">
                <div id="CameraTitle" class="card-Title x3dCamera_Subtitle drinksText"></div>

                <!--Camera Buttons-->
                <a href="#" class="btn btn-success btn-responsive" onclick="cameraFront('CokeCan');">Default</a>
                <a href="#" class="btn btn-primary btn-responsive" onclick="cameraBack('CokeCan');">Back</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraLeft('CokeCan');">Left</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraRight('CokeCan');">Right</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraTop('CokeCan');">Top</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraBottom('CokeCan');">Bottom</a>
        ...
        <div id="cokeDescription" class="row" style="display:none;">
          ...
          <!-- Row to hold one card to hold the sprite descriptive text, etc.-->
        <div id="cokeCanDescription" class="row" style="display:none;">
          <div class="col-sm-12">
            <div class="card">
              <div class="card-body">
                <div id="title_cokeCan" class="card-title drinksText"></div>
                <div id="subTitle_cokeCan" class="card-subtitle drinksText"></div>
                <div id="description_cokeCan" class="card-text drinksText"></div>
                <a href="https://www.coca-cola.co.uk/brands/coca-cola-original-taste" class="btn btn-primary btn-responsive">Visit Coke</a>
              </div>
            </div>
          </div>
        </div> <!-- End coke can description contents -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                  <h4 class="modal-title">CocaCola App contact details</h4>
